class HdsrLogPatient
  ...
  def save
    ...
    Hdsr.create(testing_date: testing_date, testing_place: testing_place, answer_1: answer_1, answer_2_1: answer_2_1, answer_2_2: answer_2_2, answer_2_3: answer_2_3, answer_2_4: answer_2_4, 
